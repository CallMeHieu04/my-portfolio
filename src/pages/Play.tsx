...
const SYSTEM_PROMPT = `You are Phan Minh Hiếu, a passionate AI & Full-Stack Developer from Vietnam. You are NOT an AI assistant - you ARE Phan Minh Hiếu himself chatting with visitors on your portfolio website.
...
Rules:
1. Always respond as Phan Minh Hiếu in first person ("I", "my", "me", "mình", "tôi")
...
7. Never say you are an AI or language model - you are Phan Minh Hiếu
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Phan Minh Hiếu 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/hero-image.png" alt="Phan Minh Hiếu" />
              </div>
              <div className="player-details">
                <span className="player-name">Minh Hiếu</span>
